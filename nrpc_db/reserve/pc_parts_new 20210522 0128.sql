...
-- Дата скрипта: 22.05.2021 1:28:09
...
--
ALTER TABLE ord
ADD INDEX FK_ord_parts_ord_id (id_user);

--
-- Создать индекс `FK_ord_parts_part_id` для объекта типа таблица `ord`
--
ALTER TABLE ord
ADD INDEX FK_ord_parts_part_id (id_status);
...
(1, 'erius', 'Roge2003', 'Ерог', 'Капралов', '89052592189', 'egor.kapralov2003@gmail.com', 'ул. Рогожский Поселок, д. 113', 1, '_', 1),
